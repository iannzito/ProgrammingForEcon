...
geom_point(size = 2, na.rm = TRUE) +
  ...
  annotate("text", 
           x = 2022, 
           y = max(temporal_long$value, na.rm = TRUE) * 1.02, # Places it slightly above the highest data point
           label = "Start of Russia War", 
           angle = 0,             # Keep it horizontal (set to 90 if you want it vertical)
           vjust = -0.5,          # Adjust vertical padding
           hjust = 0.5,           # Center the text perfectly on the line
           color = "black",
           fontface = "italic") +
  labs(
    title = "Temporal Variation of HICP and Minimum Wage Growth",
