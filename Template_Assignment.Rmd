...
dataset <- read_csv("prc_hpi_a$defaultview_linear.csv")
wages <- read_csv("tps00155_page_linear.csv")
```
...
The dataset was obtained from eurostat and was imported into R using the readr package. It contains 3,180 observations and 10 variables. The data consists out of the annual house price index (HPI) which values for multiple countries and years.
