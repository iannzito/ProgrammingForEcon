...
new_variables <- data.frame(
  ...
  Meaning = c(
    "Percentage change in HICP between 2015 and 2025, representing the increase in living costs",
    "Annual growth of statutory minimum wages across European countries"

  )
)

knitr::kable(new_variables)
